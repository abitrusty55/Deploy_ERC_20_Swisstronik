...
async function main() {
    const replace_contractAddress = "0x773fBfc52B0C47fafb31E2c22f1BA0ae4aE1dAda";
    const [signer] = await hre.ethers.getSigners();
    const replace_contractFactory = await hre.ethers.getContractFactory("SWSTestToken");
    const contract = replace_contractFactory.attach(replace_contractAddress);
  
    const replace_functionName = "mint";
    const replace_functionArgs = ["0x9141005F6Ac76bF6666E8A251dA0CEe8f4544B47","100000000000000000000"]; // 100 tokens with 18 decimal places
